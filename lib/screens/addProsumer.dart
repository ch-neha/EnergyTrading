...
class _AddLandInspectorState extends State<AddLandInspector> {
  late String address, name, age, desig, city, newaddress, energyavailable;
  var model, model2;
  double width = 490;
  int screen = 0;
  ...
  List<Menu> menuItems = [
    Menu(title: 'Add Prosumer', icon: Icons.person_add),
    Menu(title: 'All Prosumers', icon: Icons.group),
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      border: OutlineInputBorder(),
                      labelText: 'Address',
                      hintText: 'Enter Prosumer Address(MetaMask)',
                    ),
                  ),
                ),
                Padding(
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      border: OutlineInputBorder(),
                      labelText: 'Electricity Available',
                      hintText: 'Enter the amount of Electricity Available',
                    ),
                  ),
                ),
                CustomButton(
